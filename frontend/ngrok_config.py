...
def print_current_config():
    ...
    print(f"\U0001F310 Current ngrok URL: {CURRENT_NGROK_URL}")
    print(f"\U0001F517 Backend endpoint: {get_backend_url()}")
    print(f"\U0001F9EA Test endpoint: {CURRENT_NGROK_URL}/test")
    print(f"\U0001F4CA Parameters endpoint: {CURRENT_NGROK_URL}/parameters")
...
def update_ngrok_url(new_url):
    ...
    print(f"\U0001F517 New backend endpoint: {get_backend_url()}")
    print(f"\U0001F9EA New test endpoint: {CURRENT_NGROK_URL}/test")
